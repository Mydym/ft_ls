...
static t_file	*ft_recurarg__noargv(t_opt *opt, char **larg, int k, int i)
{
	t_file	*recu;
...
static void		ft_recurdir(t_file *lstdir, t_opt *opt, int k, int i)
{
	void	(*psort)(t_file **, t_file *, t_opt *);
	t_file	*lstfile;
	char	*path;
...
static void		ft_recurfilerev(t_file *lstarg, t_opt *opt, t_size max, int i)
{
	int		k;
